setwd("C:/Users/Anthony/Documents/Excel")
...
plot(datos$AlcanceX, datos$AlcanceY, main = "Regresión Lineal de AlcanceX vs AlcanceY",
     xlab = "AlcanceX", ylab = "AlcanceY", pch = 19)
abline(modelo, col = "red")  # Añade la línea de regresión en rojo
library(ggplot2)

# Crear el gráfico con ggplot2
ggplot(datos, aes(x = AlcanceX, y = AlcanceY)) + 
  geom_point() +  # Añadir puntos de dispersión
  geom_smooth(method = "lm", col = "red") +  # Añadir línea de regresión lineal
  ggtitle("Regresión Lineal de AlcanceX vs AlcanceY") +
  xlab("AlcanceX") +
  ylab("AlcanceY")
